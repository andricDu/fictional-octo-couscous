...
import static org.icgc_argo.dictionary.core.model.FeatureTypes.FeatureType;
import static org.icgc_argo.dictionary.core.model.FileTypes.FileType;
import org.icgc_argo.dictionary.core.util.DictionaryTopologicalComparator;
...
import static org.icgc_argo.dictionary.core.model.Constants.CodeListRestriction_FIELD;
import static org.icgc_argo.dictionary.core.util.Collectors.toImmutableList;
...
public class Dictionary extends BaseEntity implements HasName, DictionaryElement {
  ...
  /**
   * Related to {Dictionaries#FILE_SCHEMATA_KEY}.
   */
  @Valid
  ...
  public List<FileType> getFileTypes() {
    return copyOf(transform(files, new Function<FileSchema, FileType>() {
      ...
      public FileType apply(FileSchema input) {
        return (FileType) input.getFileType();
      }
