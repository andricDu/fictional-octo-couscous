...
import org.icgc_argo.dictionary.core.util.Collectors;
...
public class FileSchema implements DictionaryElement, Serializable {
   ...
   * <p>
   * Related to { Dictionaries#FILE_SCHEMA_NAME_KEY}.
   */
  @NotBlank
  private String name;
  ...
  /**
   * Related to { Dictionaries#FILE_SCHEMA_PATTERN_KEY}.
   */
  ...
  public List<String> getControlledFieldNames() {
    return newArrayList(getFieldNames(filter(fields, Field.IS_CONTROLLED)));
  }
  ...
  /**
   * TODO: DCC-1076 will render it unnecessary (everything would take place in {RequiredRestriction}).
   */
  @JsonIgnore
